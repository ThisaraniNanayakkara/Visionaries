...
import com.example.sethsaha.databinding.UploadPrescriptionBinding;
...
public class UploadPrescription extends AppCompatActivity {
    ...
    UploadPrescriptionBinding binding;
    Uri imageUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = UploadPrescriptionBinding.inflate(getLayoutInflater());
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(UploadPrescription.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
